    ...
    for n = 1 : length(actual_start)
        ...
        if ref_wave > 1
            ...
            if c == 2              
                ...
                SS_Core(SS_indice).Ref_Type(ref_wave)            =      type;
                SS_Core(SS_indice).Ref_TypeName{ref_wave}        =      typeName;
                SS_Core(SS_indice).Ref_Start(ref_wave)           =      actual_start(n);
                SS_Core(SS_indice).Ref_End(ref_wave)             =      actual_end(n);                    
                SS_Core(SS_indice).Ref_Length(ref_wave)          =      SS_lengths(n);
                SS_Core(SS_indice).Ref_NumberOfWaves(ref_wave)   =      length(peak_amplitudes)/2;
                SS_Core(SS_indice).Ref_Symmetry(ref_wave)        =      max_indice/(length(peak_amplitudes)-1);
        ...
        SS_Core(SS_count).Ref_Type            =      zeros(1,size(Data.SSRef, 1));
        SS_Core(SS_count).Ref_TypeName        =      cell(1,size(Data.SSRef, 1));
        ...
        SS_Core(SS_count).Ref_NumberOfWaves   =      zeros(1,size(Data.SSRef, 1));
        SS_Core(SS_count).Ref_Symmetry        =      zeros(1,size(Data.SSRef, 1));
        ...
        SS_Core(SS_count).Ref_Type(ref_wave)            =      type;
        SS_Core(SS_count).Ref_TypeName{ref_wave}        =      typeName;
        SS_Core(SS_count).Ref_Start(ref_wave)           =      actual_start(n);
        SS_Core(SS_count).Ref_End(ref_wave)             =      actual_end(n);
        SS_Core(SS_count).Ref_Length(ref_wave)          =      SS_lengths(n);
        SS_Core(SS_count).Ref_NumberOfWaves(ref_wave)   =      length(peak_amplitudes) / 2;
        SS_Core(SS_count).Ref_Symmetry(ref_wave)        =      max_indice/(length(peak_amplitudes) - 1);
